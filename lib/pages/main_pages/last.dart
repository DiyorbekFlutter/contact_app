          ...
          slivers: [
            ...
            SliverList(
              delegate: SliverChildBuilderDelegate(
                childCount: lastContacts.length,
                  (context, index) {
                  ContactModel contactModel = lastContacts[index];
                          ...
                          Expanded(
                            child: Row(
                              children: [
                                ...
                                const SizedBox(width: 20),
                                Text(contactModel.name, style: const TextStyle(fontWeight: FontWeight.bold)),
                                const Spacer(),
                                Expanded(
                                  child: Text(
                                    contactModel.lastConnecting,
    ...
    deleteDialog(
        ...
        delete: () async {
          for (var i in selected) {
            PathProviderService.deleteFile(lastContacts[i].path);
          }
